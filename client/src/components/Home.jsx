  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="relative pt-16 sm:pt-24 pb-16 sm:pb-24 px-4 sm:px-8 max-w-7xl mx-auto overflow-hidden">
        {/* Constellation Network Lines & Glowing Nodes Layer */}
        <div className="absolute inset-0 overflow-hidden pointer-events-none -z-10 select-none opacity-50 dark:opacity-75">
          <svg className="w-full h-full min-w-[700px] sm:min-w-[950px] mx-auto" viewBox="0 0 1000 420" fill="none" preserveAspectRatio="xMidYMid slice">
            <defs>
              <linearGradient id="const-line-mesh" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="#38bdf8" stopOpacity="0.05" />
                <stop offset="50%" stopColor="#818cf8" stopOpacity="0.25" />
                <stop offset="100%" stopColor="#38bdf8" stopOpacity="0.05" />
              </linearGradient>
              <radialGradient id="node-glow-halo" cx="50%" cy="50%" r="50%">
            ...
            {/* Constellation Network Interconnect Lines */}
            <g stroke="url(#const-line-mesh)" strokeWidth="1" strokeDasharray="3 4">
              <line x1="120" y1="80" x2="260" y2="160" />
              <line x1="260" y1="160" x2="390" y2="90" />
              <line x1="390" y1="90" x2="520" y2="170" />
              <line x1="520" y1="170" x2="680" y2="80" />
              <line x1="680" y1="80" x2="820" y2="150" />
              <line x1="820" y1="150" x2="930" y2="70" />

              <line x1="260" y1="160" x2="210" y2="300" />
              <line x1="210" y1="300" x2="410" y2="280" />
              <line x1="410" y1="280" x2="520" y2="170" />
              <line x1="520" y1="170" x2="630" y2="290" />
              <line x1="630" y1="290" x2="790" y2="260" />
              <line x1="790" y1="260" x2="820" y2="150" />

              <line x1="120" y1="80" x2="210" y2="300" />
              <line x1="410" y1="280" x2="630" y2="290" />
              <line x1="790" y1="260" x2="930" y2="70" />
            </g>

            {/* Glowing Constellation Nodes with coordinates & labels */}
            {[
              { x: 120, y: 80,  label: "13.34°N · 77.10°E" },
              { x: 260, y: 160, label: "DD HILLS · 1204m" },
              { x: 390, y: 90,  label: "KYATHSANDRA" },
              { x: 520, y: 170, label: "NAVORA CORE" },
              { x: 680, y: 80,  label: "MADHUGIRI FORT" },
              { x: 820, y: 150, label: "NAMADA CHILUME" },
              { x: 930, y: 70,  label: "13.66°N · 77.21°E" },
              { x: 210, y: 300, label: "SIDDAGANGA" },
              { x: 410, y: 280, label: "AMANIKERE" },
              { x: 630, y: 290, label: "KAIDALA TEMPLE" },
              { x: 790, y: 260, label: "MARKONAHALLI" },
            ].map((node, i) => (
              <g key={i} className="animate-pulse" style={{ animationDelay: `${(i * 0.35) % 2.5}s`, animationDuration: '3.5s' }}>
                <circle cx={node.x} cy={node.y} r="12" fill="url(#node-glow-halo)" />
                <circle cx={node.x} cy={node.y} r="3.5" stroke="#38bdf8" strokeWidth="1" fill="#0B1120" />
                <circle cx={node.x} cy={node.y} r="1.5" fill="#38bdf8" />
                <text
                  x={node.x}
                  y={node.y + 13}
                  textAnchor="middle"
